...
import DislikeVideosProduct2 from './media2/dislike2';
      ...
      {isLoading ? (
        ...
        <>
          {currentProducts.length > 0 && (
            <ul className='grid grid-cols-4 h-auto max-sm:grid-cols-1 max-lg:grid-cols-2
             max-md:grid-cols-2 justify-between gap-1'>
                ...
                >
                  ...
                  <div className='flex justify-between overflow-hidden'>
                    <span className='flex flex-row mb-2'>
                      <p className=''>
                        {convertPrice(product.price || 0, product.currency || 'USD').currency} {convertPrice(product.price || 0, product.currency || 'USD').price}
                      </p>
                    </span>
                    <p>{product.country}</p>
                  </div>
                  ...
                  <Link href={`/Product/Videos/${product.id}`}>
                    <button className='w-full h-7 text-white mt-3 
                    rounded-sm bg-slate-950 hover:bg-blue-900'>
                      <h1>watch video</h1>
                    </button>
                  </Link>
                </li>
