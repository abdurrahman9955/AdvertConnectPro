...
const UserProfile2 = () => {
  ...
  const [selectedRoute, setSelectedRoute] = useState<string>('Images2');
  ...
  useEffect(() => {
    const fetchProductImages = async () => {
      ...
      try {
        ...
        if (response.success) {
          setProductImages(response.productVideos); 
        } else {
    ...
    md:pt-10 max-md:pt-0  ">
        ...
        <div className="flex flex-row justify-between   ml-3 mb-5 md:ml-6
         ...
         {isFollowing ? (
            ...
            max-lg:mr-3 border-2 border-blue-950 font-bold text-blue-950  h-8 px-2
             bg-white"> Followed <GrStatusGood size={18} className='text-green-800
     ...
     '>
         ...
         <div className='   w-full  h-auto'>
          ...
          <button onClick={() => setSelectedRoute('Images2')} type='button'
           className=' text-white  w-auto px-3 h-7  mt-2 
          rounded-sm bg-teal-700 hover:bg-blue-700  shadow-lg
          '>Products </button>

          <button  onClick={() => setSelectedRoute('Banner2')} type='button'
           className=' text-white  w-auto px-3 h-7  mt-2 
          rounded-sm bg-teal-700 hover:bg-blue-700   shadow-lg
          '>Banners </button>


          <button  onClick={() => setSelectedRoute('Videos2')} type='button'
          ...
          <div className='h-auto overflow-y-auto  m-2   '>
           ...
           {selectedRoute === 'Images2' && <Images2 />}
           {selectedRoute === 'Banner2' && <Banner2 />}
