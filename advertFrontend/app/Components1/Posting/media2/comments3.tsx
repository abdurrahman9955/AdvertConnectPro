...
const Comments3 = () => {
  ...
  const handleCommentSubmit = async () => {
    try {
     ...
     return (
           <div className=''>
                <div className='flex flex-row py-1 gap-1 text-sm mt-3 pl-1'>
                <FaMessage size={24} 
                className='sm:ml-14 max-sm:ml-8'/>
                </div>

                 <button className="bg-blue-950 hover:bg-green-950 max-sm:hidden  
                 text-sm
                ...
                ( <div className='fixed md:top-20 md:left-10 max-md:top-10  max-md:left-5 
                ...
                <div className='flex justify-center'>
                  <button
                    className='flex justify-center w-28 h-7 bg-black hover:bg-green-900
                     text-white font-bold pt-1 text-sm rounded-sm'
