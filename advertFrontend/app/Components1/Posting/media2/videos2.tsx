...
import LikeVideoProduct2 from './likes2';
import DislikeVideosProduct2 from './dislike2';
import ViewRating2 from './viewRating2';
import AddToFavorites2 from './favorite2';
...
const Videos2: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        //@ts-ignore
        const response: ImageResponse = await getVideoByProfileId();
