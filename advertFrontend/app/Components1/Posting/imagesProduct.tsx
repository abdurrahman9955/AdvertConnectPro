...
const ProductDetails: React.FC = () => {
  ...
  return (
    ...
    border-2 border-slate-950 bg-slate-400 sm:p-1'>
      {isLoading ? (
        <p className='flex justify-center lg:text-2xl md:text-xl h-screen
        max-md:text-lg text-blue-950'>Loading product images...</p>
        ...
        <div className='grid grid-cols-2 max-xl:grid-cols-1 gap-1'>
            ...
            {selectedImage ? (
              <div className='relative'>
                <img
                  ...
                  style={{ maxHeight: 400, }}
                  className='border-2  border-slate-900  w-full rounded-sm cursor-pointer'
                />
          ...
          <span className='  bg-slate-200   border-2 w-full border-slate-950 p-5'>
            ...
            <p className='text-xl max-md:text-sm  max-sm:text-sm mb-10'>see full product details below</p>
      ...
      <p className=' mb-5 text-lg  max-sm:text-sm'>Company Name: {productImages[0].companyName ? productImages[0].companyName : " was not provided"}</p>

       <p className='mb-5 text-lg  max-sm:text-sm overflow-hidden'> Company Link: {productImages[0].companyLink ? (
       ...
       <button className='w-full h-8 text-white mt-3 text-sm  
       rounded-sm bg-slate-950'>
          <h1>FULL DESCRIPTION </h1>
       </button>

       <span className='flex justify-between mb-5 mt-5 text-sm  max-sm:text-sm'>
       <p> <p className='text-sm  max-sm:text-sm'>DESCRIPTION OF THE PRODUCT:</p> 
       {productImages[0].description ?productImages[0].description : " was not provided"}</p>
       </span>
