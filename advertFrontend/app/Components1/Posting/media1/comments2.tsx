...
const Comments2 = () => {
  ...
  const handleCommentSubmit = async () => {
    try {
     ...
     return (
           <div className=''>
                <div className='flex flex-row py-2 gap-1 text-xl mt-2 pl-1'>
                <FaMessage size={32} 
                ...
                ( <div className='fixed md:top-40 md:left-10 max-md:top-20  
                max-md:left-5 flex justify-center text-sm bg-slate-300 border-2
                 border-black p-2 flex-col'>
                ...
                <div>
                  <textarea
                    className='w-64 h-32  max-sm:w-48 p-3 border-2 border-black'
