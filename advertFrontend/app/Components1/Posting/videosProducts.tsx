    ...
    <div className='font-bold text-sm min-h-screen border-2 border-slate-950
     bg-slate-400 sm:p-1'>
      {isLoading ? (
        ...
        max-md:text-lg text-blue-950'>Loading product Videos...</p>
        ...
        <div className='grid grid-cols-2 max-xl:grid-cols-1 gap-1'>
            ...
            <span className=''>
              {productVideos[0].mediaUrl && (
                <div className='relative'>
                 ...
                 <video className='border-2 border-slate-900  w-full sm:rounded-lg
                 cursor-pointer'
                 style={{ maxHeight: 600}}
                  controls>
          ...
          {commentVisible && 
            ...
            <CommentListVideos2 productId={productVideos[1].id.toString()}/>
            </div>
          </span>
             )
          ...
          <span className='  bg-slate-200   border-2 w-full border-slate-950 p-5'>

            <p className='text-xl max-md:text-lg  max-sm:text-sm mb-10'>see full product details below</p>
      ...
      <p className=' mb-5 text-lg  max-sm:text-sm'>Company Name: {productVideos[0].companyName ? productVideos[0].companyName : " was not provided"}</p>

       <p className='mb-5 text-lg  max-sm:text-sm overflow-hidden'> Company Link: {productVideos[0].companyLink ? (
       ...
       <button className='w-full h-8 text-white mt-3 text-sm  max-sm:text-sm rounded-sm bg-slate-950'>
          <h1>FULL DESCRIPTION </h1>
       </button>

       <span className='flex justify-between mb-5 mt-5 text-sm  max-sm:text-sm'>
       <p> <p className='text-sm max-sm:text-sm'>DESCRIPTION OF THE PRODUCT:</p> {productVideos[0].description ?productVideos[0].description : " was not provided"}</p>
       </span>
