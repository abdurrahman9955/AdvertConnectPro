...
import Jewelry1 from './Jewelry1';
import Jewelry2 from './Jewelry2';
import Jewelry3 from './Jewelry3';
...
const Jewelries = () => {
  ...
  const [selectedRoute, setSelectedRoute] = useState<string>('Jewelry1');
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Jewelry3')}
                 type="button" className="text-lime-100 bg-indigo-950 max-sm:h-6 text-sm
                ml-3 rounded-sm h-7 mr-2 w-auto pl-5 pr-5 hover:bg-neutral-700 
                 ">Filters</button>
        ...
        <div>
          ...
          {selectedRoute === 'Jewelry1' && <Jewelry1 />}
           {selectedRoute === 'Jewelry2' && <Jewelry2 />}
           {selectedRoute === 'Jewelry3' && <Jewelry3 />}
