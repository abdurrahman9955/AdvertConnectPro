    ...
    const fetchProducts = async () => {
      try {
        ...
        if (response.success && Array.isArray(response.videos)) {
          const groceryProducts = response.videos.filter(product => product.product === 'Jewelry');
                    ...
                    {product.thumbnailUrl && (
                      <div className='relative'>
                        <img
                          ...
                          width={300}
                          height={300}
                          className='w-full border-1 border-slate-900 rounded-sm'
                        />
