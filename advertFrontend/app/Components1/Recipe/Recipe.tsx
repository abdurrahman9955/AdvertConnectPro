      ...
      <div className="border-2 border-indigo-900 max-sm:py-1 py-2 w-full  ">
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto">
               ...
               <button onClick={() => setSelectedRoute('Recipe1')}
                ...
                lg:px-7 hover:bg-neutral-700  ">Recipes</button>
             ...
             <button  onClick={handleSearch}  className='text-2xl text-blue-950  sm:hidden mr-5 '>
            ...
            <div> {SearchVisible &&  (<Search />) }</div>
               ...
               <button onClick={() => setSelectedRoute('Recipe3')}
                ...
                hover:bg-neutral-700 ">Filters</button>
