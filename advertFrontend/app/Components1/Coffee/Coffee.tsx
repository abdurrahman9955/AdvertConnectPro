...
const Coffee = () => {
  ...
  const [selectedRoute, setSelectedRoute] = useState<string>('Coffee1');
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Coffee3')}
                type="button" className="text-lime-100 bg-indigo-950
          ...
          {selectedRoute === 'Coffee1' && <Coffee1 />}
           {selectedRoute === 'Coffee2' && <Coffee2 />}
           {selectedRoute === 'Coffee3' && <Coffee3 />}
