...
const Fashion = () => {
  ...
  const [selectedRoute, setSelectedRoute] = useState<string>('Fashion1');
  ...
  return (
    <div className="w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
               ...
               <button onClick={() => setSelectedRoute('Fashion1')}
                type="button" className="text-lime-100 bg-indigo-950
                ml-3 rounded-sm h-7 text-sm max-sm:h-6  w-auto pl-5 pr-5 mr-5
                lg:px-7 hover:bg-neutral-700  ">Fashion</button>
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Fashion3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Fashion1' && <Fashion1 />}
           {selectedRoute === 'Fashion2' && <Fashion2 />}
           {selectedRoute === 'Fashion3' && <Fashion3 />}
