    ...
    const fetchProducts = async () => {
      try {
        ...
        if (response.success && Array.isArray(response.videos)) {
          const groceryProducts = response.videos.filter(product => product.product === 'Shops & Stores');
    ...
    <div className='font-bold text-sm w-full min-h-screen overflow-hidden' >
      {isLoading ? (
        ...
        <>
                  ...
                  > 
                    ...
                    {product.thumbnailUrl && (
                      <div className='relative'>
                        <img
                          ...
                          width={300}
                          height={300}
                          className='w-full border border-slate-900 rounded'
                        />
                    ...
                    <div className='flex justify-between flex-wrap'>
                      <button className='flex flex-row bg-blue-50 border
                       border-black rounded-full h-8 mt-2 p-1'>
          ...
          No Shops/Stores with video found!
        </p>}
        </>
      )}
    </div>
