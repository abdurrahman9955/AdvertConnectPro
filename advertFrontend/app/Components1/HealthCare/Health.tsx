    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Health3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Health1' && <Health1 />}
           {selectedRoute === 'Health2' && <Health2 />}
           {selectedRoute === 'Health3' && <Health3 />}
