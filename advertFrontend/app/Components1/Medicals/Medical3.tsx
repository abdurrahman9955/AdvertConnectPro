...
import { updateFilter22, resetFilter22  } from '@/app/app/filters/filter22'; 
...
const Medical3 = () => {
  ...
  useEffect(() => {
    const storedFilter = Cookies.get('filter22');
    if (storedFilter) {
  ...
  const handleSubmit = () => {
    ...
    dispatch(updateFilter22(parsedFilter));
    Cookies.set('filter22', JSON.stringify(parsedFilter), { expires: 1, path: '/' });
    setShowResetButton(true); 
  };


  const handleReset = () => {
    dispatch(resetFilter22()); 
    Cookies.remove('filter22', { path: '/' }); 
    setFilter({
      city: '',
      country: '',
      state: '',
          ...
          <div className=' w-full  h-auto '>
             ...
             <div className='flex justify-center mt-10'>
              ...
              <div className='flex justify-center mt-5 gap-4'>
                ...
                <input type='text' 
                className='h-sm border-2 border-indigo-950 bg-white
                pl-5 text-sm max-sm:w-40' 
           ...
           <div className='flex justify-center mt-5 gap-4'>
            {showResetButton ? (
              <button
                ...
                max-lg:w-2/5 max-sm:w-3/5 h-7 rounded-full mb-10
