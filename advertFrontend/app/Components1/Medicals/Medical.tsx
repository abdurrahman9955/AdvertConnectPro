...
const Medical = () => {
  ...
  const [selectedRoute, setSelectedRoute] = useState<string>('Medical1');
    ...
    <div className="w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Medical3')}
                 type="button" className="text-lime-100 bg-indigo-950
                ml-3 rounded-sm h-7 max-sm:h-6 text-sm  sm:mr-2  w-auto pl-5 pr-5
          ...
          {selectedRoute === 'Medical1' && <Medical1 />}
           {selectedRoute === 'Medical2' && <Medical2 />}
           {selectedRoute === 'Medical3' && <Medical3 />}
