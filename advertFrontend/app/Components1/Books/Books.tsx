...
const Books = () => {
  ...
  const [selectedRoute, setSelectedRoute] = useState<string>('Books1');
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
               ...
               <button onClick={() => setSelectedRoute('Books1')}
                ...
                ml-3 rounded-sm h-7 max-sm:h-6 w-auto pl-5 pr-5 mr-5
                lg:px-7 hover:bg-neutral-700 text-sm ">Books</button>
