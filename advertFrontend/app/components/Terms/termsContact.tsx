...
const TermsContact = () => {
    return (
      <div className='flex justify-center flex-col  pt-2 w-full font-boldborder-4 border-green-950 '>
         ...
         <p className='text-xl pt-5 px-5 max-md:text-xl'>Contact Us</p>
        ...
        <p className='text-xl pt-5 px-5 max-md:text-xl'>Multiple Channels for Communication:</p>
        ...
        <p className='text-xl pt-5 px-5 max-md:text-xl'>Swift and Personalized Response:</p>
        ...
        <p className='text-xl pt-5 px-5 max-md:text-xl'>User-Centric Approach:</p>
        ...
        <p className='text-xl pt-5 px-5 max-md:text-xl'>Privacy and Communication Preferences:</p>
        ...
        <p className='text-xl pt-5 px-5 max-md:text-xl'>Connect with Us on Social Media:</p>
