      ...
      <div className="flex justify-center">
        ...
        border-4 border-blue-950 pt-2 max-md:w-full m-1 md:text-xl">
          <div className="flex justify-between w-full px-2 border-slate-950 gap-4">
            <div className="shadow-lg w-full bg-blue-950  h-7  max-sm:h-6  rounded flex-initial">
              <h1 className="flex justify-center font-bold text-white mt-1 text-sm">Following</h1>
            </div>
          </div>
