...
const More = () => {
  ...
  return (
    <div className='flex justify-center flex-col  pt-2 w-full
     font-boldborder-4 border-blue-950 '>
        ...
        '>You now have ({totalOrders}) Order</h1>
         ...
         <div className='flex flex-col    lg:w-2/4 md:mb-10 max-lg:w-3/4 font-bold 
          border-4 border-blue-950 pt-5 max-md:w-full m-1   md:text-xl '> 

              <div className="flex justify-between w-full px-2
                border-slate-950  gap-4">

          
               <div className=" shadow-lg w-full bg-blue-950   h-9
                 rounded flex-initial">
                  
                   <h1 className='flex justify-center font-bold text-white mt-2
                   text-sm'> See All  Order Below</h1>
                </div>
