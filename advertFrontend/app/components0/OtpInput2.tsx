    ...
    <div className='h-screen border-4 border-purple-950 font-bold'>
        ...
        <span className='w-60 h-11 mt-10 text-sm text-left max-sm:m-10'>
          <h1 className='flex justify-between'>
            ...
            <button
              ...
              className={`w-auto h-7 hover:bg-indigo-950 max-sm:text-sm rounded-xl
               px-5 bg-slate-0 text-black ${ resendDisabled ? 'opacity-50 cursor-not-allowed' : 'border-l-4 border-slate-950 hover:text-white'
              }`}
      ...
      <div className='flex justify-center'>
        <button
          ...
          max-md:w-3/5 h-7 rounded-xl hover:bg-purple-950 mt-2 text-sm'
        >
