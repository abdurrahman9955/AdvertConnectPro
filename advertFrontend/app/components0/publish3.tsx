  ...
  return (
    <div className='   py-10 border-4 border-purple-950' >
     ...
     <button type='button' 
      ...
      <div className='flex justify-center'>
         <span className='lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-full
          max-sm:mx-2 h-auto 
     ...
     <button type='button' 
      ...
      <input type='text'
       ...
       h-7   text-xl text-blue-950 font-bold
      ...
      <label htmlFor="file-input" className="cursor-pointer mx-10 text-sm
       bg-blue-900 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded-full">
     ...
     <div className="flex overflow-x-auto mt-5">
      {selectedFiles.map((file, index) => (
        <div key={index} className="relative flex-shrink-0">
          <video className="rounded-lg m-2 h-40" controls>
          ...
          <div
            ...
            className="absolute top-2 right-2 m-3 p-2 bg-red-600 text-white 
            rounded-full"
          >
            <FiTrash />
          </div>
      ...
      <div className='flex flex-col'>
        ...
        mx-10 bg-blue-900 hover:bg-blue-700 text-white font-bold py-1 px-4
          ...
          {selectedThumbnails.map((file, index) => (
            <div key={index} className="relative flex-shrink-0">
              <Image
                ...
                alt={file.name}
                className=' border border-black rounded-lg m-2 h-48  '
              />
