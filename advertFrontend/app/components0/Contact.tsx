...
const Contact = () => {
  ...
  return (
    ...
    border-purple-950 '>
      ...
      <label
      htmlFor='name'
       className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-4/5 h-12 mt-5  text-sm
        focus:outline p-2
      ...
      <input type='text' 
       ...
       className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-full max-sm:mx-2 h-8  
        text-sm
      ...
      <textarea
       ...
       <button  
         ...
         className=' rounded-full bg-green-950 lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 
         max-sm:w-4/5
         text-sm text-white  h-8 mt-10 hover:bg-purple-950 mb-2'>
         {loading ? 'Submitting...' : 'Contact us'}
         </button>
         </div>

         {contactState.error && (
         <div className='flex justify-center text-red-500 text-lg m-5'>
        ...
        {successMessage && (
          <div className='flex justify-center text-green-500 text-lg m-5 mb-10'>
          {successMessage}
          </div>
        )}
