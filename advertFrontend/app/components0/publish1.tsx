...
const Publish1 = ()  => {
  ...
  return (
    <div className='   py-10  border-4 border-purple-950' >
      <div >
        <h1 className='flex justify-center md:text-2xl text-lg text-blue-950 
        font-family-bold
     ...
     <button type='button' 
       ...
       max-sm:w-full max-sm:mx-2 h-auto mt-5  text-sm 
       ...
       className=' w-80 text-sm p-2   max-sm:w-48
     ...
     <button type='button' 
      ...
      <label  className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5
       max-sm:w-full max-sm:mx-2 h-8 mt-5  text-lg
      ...
      <input type='text'
       ...
       h-8  text-xl text-blue-950 font-bold
      ...
      <input type='text'
       ...
       onChange={handleInputChange}
       className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-full 
       max-sm:mx-2 h-10  text-sm
      ...
      <input type='text'
        ...
        onChange={handleInputChange}
        className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-full max-sm:mx-2
        h-8  text-xl focus:outline-none
         p-2  rounded-xl
         text-left 
        border-b-4 border-blue-950' />
      </div>
      ...
      <input type='text'
        ...
        onChange={handleInputChange}
        className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-full max-sm:mx-2
        h-8 text-sm focus:outline-none
         p-2  rounded-xl
         text-left 
        border-b-4 border-blue-950' />
      </div>
      ...
      <input type='text'
        ...
        onChange={handleInputChange}
       className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-full max-sm:mx-2 h-10   
       text-sm
         p-2 focus:outline-none rounded-xl
         text-left 
        border-b-4 border-blue-950' />
      ...
      <div className='flex flex-col'>
        ...
        <label htmlFor="file-input" className="cursor-pointer mx-10 bg-blue-900
         hover:bg-blue-700 text-white font-bold py-1 px-4 text-sm rounded-full">
          ...
          {selectedFiles.map((file, index) => (
            <div key={index} className="relative flex-shrink-0">  
              <Image
                ...
                width={300}
                height={300}
                className='border border-black rounded-lg m-3 h-44 w-48'
              />
