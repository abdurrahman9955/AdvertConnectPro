...
const Publish1 = ()  => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const uploadResponse = await uploadImage(formDataToSend);
  ...
  <p className='justify-center'> we are now publishing your product.</p>
  </div>
    ...
    <div className='   py-20 border-4 border-purple-950' >
      <div >
        <h1 className='flex justify-center md:text-4xl text-2xl text-blue-950 font-family-bold
         font-bold'>upload & publish your images </h1>
      </div >
