...
const Individual = () => {
  ...
  return (
    <div className=' h-screen py-10 pt-16 md:border-4 border-purple-950' >
      <div >
        <h1 className='flex justify-center md:text-3xl text-2xl text-blue-950 font-family-bold
     ...
     <div className="flex justify-center mt-6">
      ...
      lg:w-2/5 max-lg:w-2/3 max-md:w-4/5  h-10
       text-slate-50 bg-blue-950 mt-10
      hover:bg-blue-800 rounded-full max-sm:w-4/5  
      text-xl '>upload your images</button>
      </div></Link>
      ...
      lg:w-2/5 max-lg:w-2/3 max-md:w-4/5  h-10
       text-slate-50 bg-blue-950 mt-10
      hover:bg-blue-800 rounded-full max-sm:w-4/5  
      text-xl '>upload your banner</button>
      </div></Link>
      ...
      <button type='submit' className='
      lg:w-2/5 max-lg:w-2/3 max-md:w-4/5  h-10
       text-slate-50 bg-blue-950 mt-10 max-sm:mb-14
      hover:bg-blue-800 rounded-full max-sm:w-4/5  
      text-xl '>upload your videos</button>
      </div></Link>
