...
const Sign_in = () => {
  ...
  return (
    <div className='py-10 pt-15 font-bold mt-28'>
      <div>
        <h1 className='flex justify-center text-5xl text-blue-950'> Sign In</h1>
      </div>
      ...
      <form >
        ...
        <input
          ...
          border-4 border-blue-950 max-sm:m-2
       ...
       <div className='flex justify-center '>
       <Link href={{pathname: '/Sign_Up'}}> <p className='text-xl  mt-1'>
       don't have an account? <span className='text-indigo-950 text-2xl font-bold
        '>Sign In</span></p> </Link>
      </div>

      <div className='flex justify-center '>
       <Link href={{pathname: '/Sign_In/Forgot_Password'}}> <p className='text-xl  mt-5'>
       <span className='text-indigo-950 text-2xl font-bold
        '>I forgot my password?</span></p> </Link>
      </div>

      {loginError && <p className='flex justify-center   text-red-500  text-2xl mt-2'>{loginError}</p>}
      {successMessage && <p className='flex justify-center text-green-500 text-2xl mt-2'>{successMessage}</p>}
