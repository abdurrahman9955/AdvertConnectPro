    ...
    <div className="flex justify-center flex-wrap   md:border-4 border-blue-950  md:pt-10 max-md:pt-0  ">
       <div className="flex  flex-col   max-md:w-5/6 max-sm:w-full  m-0 max-lg:w-4/6  lg:w-3/6 xl:w-2/6">
        ...
        <div className="border-4 border-blue-950 bg-white">
          <h1 className="flex justify-center text-5xl text-blue-950 font-bold pt-5 
          max-sm:text-xl">My profile </h1>
          <div className="flex justify-center relative">
            <div className="w-80 h-80 mt-10 border-4 border-orange-950 bg-orange-100 
            rounded-full relative">
              ...
              {selectedImage && (
                <button onClick={handleUpload} className="absolute bottom-20 right-10
                 bg-lime-800 hover:bg-blue-900 text-white text-2xl  rounded-full p-2">
                  <FaCloudUploadAlt size={40} className="ml-4 -pt-5"/>
                  <h1 className="text-lg px-2 pb-2">upload</h1>
                </button>
              )}

              {profileImage && (
                <button className="absolute bottom-2 right-10
                bg-blue-950 hover:bg-blue-900 text-white text-2xl  rounded-full p-3">
       ...
       {totalCount}
        ...
        <Link href={{pathname:'/Feedback'}}>
         <button type="button" className="text-xl text-blue-950 bg-white px-5 py-2 mt-5
         rounded shadow-lg max-sm:px-4 hover:bg-teal-200 border-4 border-blue-950 ">Feedback
         </button></Link>
