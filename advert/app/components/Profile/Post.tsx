      ...
      {isLoading ? (
        ...
        <>
          {Object.keys(groupedProducts).length > 0 && (
            <ul className='grid grid-cols-3 max-xl:grid-cols-2 h-auto overflow-y-auto max-sm:grid-cols-1 max-lg:grid-cols-2 max-md:grid-cols-1 justify-between gap-2'>
