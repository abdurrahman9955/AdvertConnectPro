  ...
  return (
    <div className='font-bold text-xl w-full min-h-screen overflow-hidden' >
       ...
       <div className="flex justify-between w-full px-2 border-slate-950 my-10  gap-4">
        <div className=" shadow-lg w-full bg-blue-950 border-2  h-10 border-slate-950
         rounded flex-initial">
             <h1 className='flex justify-center font-bold text-white mt-1
             text-2xl'>Favorite videos Product</h1></div></div>
        ...
        <>
          {products.length > 0 && (
            <ul className='grid grid-cols-3 h-auto overflow-y-auto max-sm:grid-cols-1
             max-xl:grid-cols-2 max-md:grid-cols-2 justify-between gap-2'>
