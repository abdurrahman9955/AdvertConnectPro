    ...
    return (
      <div className='flex justify-center flex-col  pt-2 w-full font-boldborder-4 border-blue-950 '>
         <div className='flex justify-center'>
           ...
           <h1 className='flex justify-center pt-1 font-bold text-white  text-2xl'>Data Security</h1>
          ...
          <div>
         <h1>
         <p className='text-3xl pt-5 px-5 max-md:text-3xl'>Data Security</p>
          ...
          <p className='text-3xl pt-5 px-5 max-md:text-3xl'>Encryption:</p>
           ...
           <p className='text-3xl pt-5 px-5 max-md:text-3xl'>Access Controls:</p>
           ...
           <p className='text-3xl pt-5 px-5 max-md:text-3xl'>Continuous Monitoring and Improvement:</p>
          ...
          measures remain robust and effective in safeguarding your data.</p>
           ...
           <p className='text-3xl pt-5 px-5 max-md:text-3xl'>User Education and Awareness:</p>
