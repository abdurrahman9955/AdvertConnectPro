...
import Restaurants1 from './Restaurants1';
import Restaurants2 from './Restaurants2';
import Restaurants3 from './Restaurants3';
...
const Restaurants = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Restaurants1'
  ...
  return (
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
               ...
               <button onClick={() => setSelectedRoute('Restaurants1')}
                type="button" className="text-lime-100 bg-indigo-950
                ml-3 rounded-xl h-10  w-auto pl-5 pr-5 mr-5
                lg:px-7 hover:bg-neutral-700  ">Restaurants</button>
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Restaurants3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Restaurants1' && <Restaurants1 />}
           {selectedRoute === 'Restaurants2' && <Restaurants2 />}
           {selectedRoute === 'Restaurants3' && <Restaurants3 />}
