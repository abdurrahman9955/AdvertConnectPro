...
const Sports = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Sports1'
    ...
    <div className="w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
               ...
               <button onClick={() => setSelectedRoute('Sports1')}
                ...
                lg:px-7 hover:bg-neutral-700  ">Sports</button>
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Sports3')}
                 type="button" className="text-lime-100 bg-indigo-950
