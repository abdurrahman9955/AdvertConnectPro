...
import Materials3 from './Materials3';
...
const Materials = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Materials1'
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Materials3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Materials1' && <Materials1 />}
           {selectedRoute === 'Materials2' && <Materials2 />}
           {selectedRoute === 'Materials3' && <Materials3 />}
