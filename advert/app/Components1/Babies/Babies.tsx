...
const Babies = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Babies1'
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Babies3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Babies1' && <Babies1 />}
           {selectedRoute === 'Babies2' && <Babies2 />}
           {selectedRoute === 'Babies3' && <Babies3 />}
