...
const Software = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Software1'
    ...
    <div className="w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Software3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Software1' && <Software1 />}
           {selectedRoute === 'Software2' && <Software2 />}
           {selectedRoute === 'Software3' && <Software3 />}
