...
const Building = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Building1'
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Building3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Building1' && <Building1 />}
           {selectedRoute === 'Building2' && <Building2 />}
           {selectedRoute === 'Building3' && <Building3 />}
