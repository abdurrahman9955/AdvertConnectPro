...
const Properties = () => {
  const initialRoute = localStorage.getItem('selectedRoute') || 'Properties1'
    ...
    <div className=" w-full ">
        ...
        <div className="flex justify-items-center  max-lg:justify-between overflow-x-auto  ">
            ...
            (<Search />)
               ...
               <button onClick={() => setSelectedRoute('Properties3')}
                 type="button" className="text-lime-100 bg-indigo-950
        ...
        <div>
          ...
          {selectedRoute === 'Properties1' && <Properties1 />}
           {selectedRoute === 'Properties2' && <Properties2 />}
           {selectedRoute === 'Properties3' && <Properties3 />}
