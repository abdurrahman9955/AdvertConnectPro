...
const ProductImages: React.FC = () => {
  ...
  return (
    <div className='font-bold text-xl min-h-screen overflow-hidden'>
      {isLoading ? (
        <p className='lg:text-5xl md:text-3xl w-full h-screen
        ...
        <>
          ...
          className='lg:text-5xl md:text-3xl h-screen max-md:text-2xl text-blue-950'>
          No products with images found!  </p>}
        </>
      )}
    </div>
  );
